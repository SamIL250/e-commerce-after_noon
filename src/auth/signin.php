<div class="p-32">
    <div class="p-10 flex justify-center">
        <div class="p-5 w-[60%] border rounded-md border-gray-300 shadow-sm ">
            ...
            <div class="px-20 my-10 grid gap-6">
                <div class="grid gap-3">
                    <label for="" class="font-bold text-gray-600">Username</label>
                    <input type="text" name="" class="border-1 w-[100%] p-3 rounded-md border-gray-300 outline-none focus:border-blue-900" id="">
                </div>
                <div class="grid gap-3">
